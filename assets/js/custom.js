...
function myFunction_1() {
    ...
    var languages_1 = document.getElementById("languages_1");
    var languages_2 = document.getElementById("languages_2");
    ...
    if (languages_1.value === "en") {
        languages_2.value = "en";
...
function myFunction_2() {
    ...
    if (languages_2.value === "en") {
        languages_1.value = "en";
        title.innerHTML = "RRL Security Pvt. Ltd.";
        intro.innerHTML = "Introduction";
        services_link.innerHTML = "Services";
        services.innerHTML = "Services";
